...
"https://github.com/brave/adblock-lists/raw/refs/heads/master/brave-unbreak.txt",
...
def intercept(info: interceptor.Request):
    redirect(info, "youtube.com", "inv.nadeko.net")
    redirect(info, "www.youtube.com", "inv.nadeko.net")
    redirect(info, "m.youtube.com", "inv.nadeko.net")
    redirect(info, "youtu.be", "inv.nadeko.net")
    
    redirect(info, "twitter.com", "nitter.it")
    redirect(info, "www.twitter.com", "nitter.it")

    redirect(info, "reddit.com", "teddit.net")
    redirect(info, "www.reddit.com", "teddit.net")
